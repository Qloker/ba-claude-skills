...
| Skill | Назначение |
|-------|------------|
| [`skills/use-case`](skills/use-case/SKILL.md) | Составление требований в формате **Вариант использования (Use Case)** по методологии Алистера Коберна. Покрывает: описание ВИ (13 полей), принцип «данные отдельно — требования ссылаются» со справочными таблицами для сущностей и экранов, правила критериев приёмки (язык бизнеса, антипаттерны), расширения с отдельными подшагами для исходов, генерация `.docx`. |
